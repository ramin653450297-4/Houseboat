    ...
    <?php 
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo "<img src='imges/rooms/".$row["rm_id"].".jpg' class='card-img-top'>";
                ...
                echo "</span>";
                echo "<a href='anonybookingroom.php?check_in=$check_in&check_out=$check_out&amount=$amount&rm_id=".$row['rm_id']."' class='btn btn-outline-dark'>จองห้องพัก</a>";
                echo "</div>";
                echo "</div>";
                echo "</div>";
                $count++;
